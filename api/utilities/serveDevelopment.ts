...
export default function serveDevelopment(app: Express, ports: { api: number; client: number }) {
...
async function redirectToDevelopmentClient(app: Express, apiPort: number, clientPort: number) {
